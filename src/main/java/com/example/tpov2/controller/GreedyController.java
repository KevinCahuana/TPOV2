...
public class GreedyController {
    ...
    @Operation(
            ...
            description = "Implementa un algoritmo voraz para recomendar un nuevo amigo a un usuario. " +
                    ...
                    "aquel que comparta la mayor cantidad de intereses. Esta es una 'elección localmente óptima' " +
                    "con la esperanza de que conduzca a una buena recomendación global."
    )
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Usuario inicial no encontrado o no hay recomendación posible.", content = @Content)
    })
